  ...
  <body>
    <div id="userbar">
      ...
      if($_SESSION['status']==1)
      {
       ...
       <li><a href="workstenders.php">Works Tenders</a></li> 
       <li><a href="suppliestenders.php">Supplies Tenders</a></li> 
       <li><a href="">Services Tenders</a></li> 
...
$counter = 1; 
 ...
 $query = "SELECT category.category_name, tenders.tender_no, tenders.tender_name, tenders.organization_nme, user.name, tenders.closing_date  FROM tenders, category, user WHERE tenders.user_id=user.user_id AND tenders.category_id=category.category_id AND category.category_id='ct02' ORDER BY closing_date desc"; 
